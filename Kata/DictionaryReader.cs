...
/// <summary>
/// This is an extension class for the StreamReader class that allows us to read a stream of text with the required formatting for this Kata, so no additional processing is required.
/// </summary>
public static class DictionaryReader
{
    private const int DefaultWordSize = 16;

    static readonly StringBuilder WordBuilder = new(DefaultWordSize);
    ...
    public static string GetNextWord(this StreamReader reader)
    {
        WordBuilder.Clear();
        ...
        if (WordBuilder.Length == 0 & !reader.EndOfStream)
